# Development Viewpoint — Anastomotic Architecture
...
```mermaid
graph TD
  subgraph MONOREPO["Anastomotic Monorepo (pnpm workspaces)"]
    direction TB

    DESKTOP["@anastomotic/desktop<br/><i>Electron app · v0.3.8</i><br/>apps/desktop/"]
    WEB["@anastomotic/web<br/><i>React UI · v0.0.1</i><br/>apps/web/"]
    CORE["@anastomotic_ai/agent-core<br/><i>Shared library · v0.4.0</i><br/>packages/agent-core/"]
...
| **Apps**             | `@anastomotic/desktop` (Electron 35), `@anastomotic/web` (React 19) |
| **Shared library**   | `@anastomotic_ai/agent-core` (TypeScript ESM)                       |
