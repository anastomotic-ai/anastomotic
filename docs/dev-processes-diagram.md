# Anastomotic — Dev Mode Process Architecture
...
flowchart TB
    ...
    dev_cjs -- "spawn: pnpm -F @anastomotic/web dev" --> vite_proc
    dev_cjs -- "spawn (after :5173 ready): pnpm -F @anastomotic/desktop dev" --> electron_proc
