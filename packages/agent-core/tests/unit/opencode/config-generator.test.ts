...
describe('ConfigGenerator', () => {
  ...
  describe('ANASTOMOTIC_AGENT_NAME', () => {
    it('should be "anastomotic"', () => {
  ...
  describe('generateConfig', () => {
    ...
    it('should set default agent to anastomotic', () => {
      const options: ConfigGeneratorOptions = {
        ...baseOptions,
        mcpToolsPath,
        userDataPath,
      ...
      expect(result.config.default_agent).toBe(ANASTOMOTIC_AGENT_NAME);
    });
    ...
    it('should configure agent with correct mode', () => {
      ...
      expect(result.config.agent?.[ANASTOMOTIC_AGENT_NAME]?.mode).toBe('primary');
    });
  ...
  describe('system prompt content', () => {
    it('should include identity section', () => {
      ...
      expect(result.systemPrompt).toContain('Anastomotic');
    });
