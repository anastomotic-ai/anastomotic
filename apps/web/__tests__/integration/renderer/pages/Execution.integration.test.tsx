...
import type { Task, TaskStatus, TaskMessage, PermissionRequest } from '@anastomotic_ai/agent-core';
import { OAuthProviderId, PROMPT_DEFAULT_MAX_LENGTH } from '@anastomotic_ai/agent-core/common';
...
// Mock Anastomotic icon
vi.mock('/assets/anastomotic-icon.png', () => ({ default: 'anastomotic-icon.png' }));
...
describe('Execution Page Integration', () => {
  beforeEach(() => {
    ...
    (window as Window & { anastomotic: typeof mockAnastomotic }).anastomotic = mockAnastomotic;
    // Reset store state
    mockStoreState = {
      currentTask: null,
      loadTaskById: mockLoadTaskById,
