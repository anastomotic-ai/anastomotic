...
import type { ConnectedProvider, NimCredentials } from '@anastomotic_ai/agent-core/common';
import {
  ModelSelector,
  ConnectButton,
  ConnectedControls,
...
export function NimProviderForm({
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const result = await api.testNimConnection(trimmedUrl, trimmedKey);
      if (!result.success) {
      ...
      await api.addApiKey('nim', trimmedKey);
