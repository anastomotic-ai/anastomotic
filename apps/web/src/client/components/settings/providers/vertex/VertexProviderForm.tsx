...
export function VertexProviderForm({
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const validation = await api.validateVertexCredentials(credentials);
      ...
      // Save credentials
      await api.saveVertexCredentials(credentials);

      // Fetch available models
      const credentialsJson = JSON.stringify(credentials);
      const modelsResult = await api.fetchVertexModels(credentialsJson);
