...
import { PROMPT_DEFAULT_MAX_LENGTH } from '@anastomotic_ai/agent-core/common';
...
export function TaskInputBar({
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        className={cn(
          'rounded-[12px] border bg-popover/70 transition-all duration-200 ease-anastomotic cursor-text focus-within:border-muted-foreground/40',
          isDragOver
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition-all duration-200 ease-anastomotic ${
                    isLoading
