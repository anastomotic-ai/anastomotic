 ...
 * - Shows "Anastomotic" instead of "Electron" in macOS Cmd+Tab and Dock
 * - Registers the "anastomotic://" URL scheme so OAuth callbacks route to the running dev instance
 */
const fs = require('fs');
const path = require('path');

const APP_NAME = 'Anastomotic';
const URL_SCHEME = 'anastomotic';
...
// Add CFBundleURLTypes for the anastomotic:// protocol (if not already present)
