...
// Mock @anastomotic_ai/agent-core - agent-core package exports used by adapter
...
describe('OpenCode Adapter Module', () => {
  ...
  beforeEach(async () => {
    ...
    // OpenCodeAdapter is now internal to agent-core, get it from the mocked @anastomotic_ai/agent-core module
    const agentCoreModule = await import('@anastomotic_ai/agent-core');
