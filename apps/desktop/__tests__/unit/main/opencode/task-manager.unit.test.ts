...
import type { TaskManagerOptions } from '@anastomotic_ai/agent-core';
...
// Mock @anastomotic_ai/agent-core module - this is where OpenCodeAdapter and TaskManager actually live
