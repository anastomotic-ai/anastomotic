...
// Mock @anastomotic_ai/agent-core - comprehensive mock covering all exports used by handlers.ts
vi.mock('@anastomotic_ai/agent-core', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@anastomotic_ai/agent-core')>();
...
// Note: App settings and provider settings are now mocked via @anastomotic/core mock above
...
describe('IPC Handlers Integration', () => {
  ...
  describe('Settings Handlers', () => {
    ...
    it('settings:set-debug-mode should update debug mode', async () => {
      ...
      // Assert
      const { setDebugMode } = await import('@anastomotic_ai/agent-core');
    ...
    it('opencode:auth:slack:status should return Slack MCP auth status', async () => {
      const { getSlackMcpOauthStatus } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Task Handlers', () => {
    ...
    it('task:delete should remove task from history', async () => {
      ...
      // Assert
      const { deleteTask } = await import('@anastomotic_ai/agent-core');
    ...
    it('task:clear-history should clear all tasks', async () => {
      ...
      // Assert
      const { clearHistory } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Onboarding Handlers', () => {
    ...
    it('onboarding:set-complete should update onboarding status', async () => {
      ...
      // Assert
      const { setOnboardingComplete } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Model Handlers', () => {
    ...
    it('model:set should update selected model', async () => {
      ...
      // Assert
      const { setSelectedModel } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Task Callbacks and Message Batching', () => {
    ...
    it('task:start should save task to history', async () => {
      ...
      // Assert
      const { saveTask } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Session Resume with Existing Task', () => {
    ...
    it('session:resume should add user message to existing task', async () => {
      ...
      // Assert
      const { addTaskMessage } = await import('@anastomotic_ai/agent-core');
    ...
    it('session:resume should update task status in history', async () => {
      ...
      // Assert
      const { updateTaskStatus } = await import('@anastomotic_ai/agent-core');
  ...
  describe('Favorites Handlers', () => {
    ...
    it('favorites:add should add a completed task to favorites', async () => {
      ...
      const { addFavorite } = await import('@anastomotic_ai/agent-core');
    ...
    it('favorites:remove should remove task from favorites', async () => {
      ...
      const { removeFavorite } = await import('@anastomotic_ai/agent-core');
    ...
    it('favorites:list should return favorites list', async () => {
      ...
      const { getFavorites } = await import('@anastomotic_ai/agent-core');
