...
export { OpenCodeCliNotFoundError, createTaskManager } from '@anastomotic_ai/agent-core';
...
import { createTaskManager, type TaskManagerAPI } from '@anastomotic_ai/agent-core';
import {
  createElectronTaskManagerOptions,
  isCliAvailable,
  getBundledOpenCodeVersion,
