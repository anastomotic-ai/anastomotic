...
import { validateApiKey, validateAzureFoundry, sanitizeString } from '@anastomotic_ai/agent-core';
import {
  ALLOWED_API_KEY_PROVIDERS,
  STANDARD_VALIDATION_PROVIDERS,
} from '@anastomotic_ai/agent-core';
import type { ZaiRegion } from '@anastomotic_ai/agent-core';
import { storeApiKey, getApiKey, deleteApiKey, hasAnyApiKey } from '../../../store/secureStorage';
import { getStorage } from '../../../store/storage';
import { getLogCollector } from '../../../logging';
import { getOpenAiOauthStatus } from '@anastomotic_ai/agent-core';
    ...
    async (
      ...
      if (STANDARD_VALIDATION_PROVIDERS.has(provider)) {
        ...
        const result = await validateApiKey(
          provider as import('@anastomotic_ai/agent-core').ProviderType,
          sanitizedKey,
          {
            timeout: API_KEY_VALIDATION_TIMEOUT_MS,
            baseUrl:
