 ...
 * platform-agnostic LogFileWriter from @anastomotic/core.
 */

import path from 'path';
import { app } from 'electron';
import { createLogWriter, type LogWriterAPI } from '@anastomotic_ai/agent-core';

// Re-export types from shared package for backward compatibility
export type { LogLevel, LogSource, LogEntry } from '@anastomotic_ai/agent-core';
