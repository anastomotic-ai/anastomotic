 ...
 *
 *   anastomotic-cli schedule "0 9 * * 1-5" "Check email and summarize"
 *   anastomotic-cli list-scheduled
 *   anastomotic-cli cancel-scheduled sched-abc123
 *   anastomotic-cli run "Research open source AI models"
 *
